export const testInput = `shiny gold bags contain 2 dark red bags.
...
export const input = `plaid magenta bags contain 2 clear lavender bags, 3 clear teal bags, 4 vibrant gold bags.
